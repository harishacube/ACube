...
const TestimonialCarousel = () => {
    ...
    return (
        <section className="testimonial-section px-0">
            <Container fluid>
                <h1 className="title-text text-uppercase text-center text-white mb-3 mb-lg-5">What people say about us</h1>
                        ...
                        <div className="pt-50" key={index}>
                            ...
                            <div className="bg-light p-4 pb-5 mx-3 rounded-4 card-height h-100">
                                <div className="content-block">
                                    <h4 className="mb-2 mb-lg-3 fw-bold text-primary">{testimonial.name}</h4>
