                    ...
                    <Row>
                        <Col xs="12" lg="6">
                            <div className="content-block mb-3">
                                ...
                                <p className="text-white mb-3 mb-lg-5">Begin Your Journey by Consulting Our Experts on Scaling Business Insights with Advanced Data Foundations, Modernization, and Platform Management.</p>
                                <div className="mb-2">
