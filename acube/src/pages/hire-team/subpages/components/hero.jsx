...
const HeroBanner = ({ title, backgroundImage, content, bannerImage, alt, developer }) => {
    const { scrollToForm } = useScroll();
    return (
        <section className="hero-section" style={{ backgroundImage: `url(${backgroundImage})` }}>
            <Container fluid className="p-4 p-lg-5">
                <Row>
                    <Col xs="12" lg="8" className="order-2 order-lg-1 mt-4 mt-lg-0">
                        ...
                        <div className="d-flex align-items-center gap-5 flex-wrap my-5 px-5 px-lg-0">
                            <div>
                                <div className="d-flex gap-2 align-items-center">
                                    <div>
                                        <img src={pricing} alt="pricing" />
                                    </div>
                                    <Button variant="link" onClick={scrollToForm} className="p-0 text-decoration-underline text-white">
